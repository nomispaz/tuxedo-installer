...
patch ~/git_clones/tuxedo-keyboard/src_pkg/rpm_pkg.spec ~/git_clones/tuxedo-installer/rpm_pkg.patch
...
# install prerequisites
sudo zypper install git gcc gcc-c++ make nodejs npm systemd-devel
# clone current git
